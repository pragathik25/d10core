...
class EditorImageDialog extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // Set width and height values for the image.
    if ($form_state->getValue('width')) {
      ...
      $form_state->setValue(['attributes', 'width'], $form_state->getValue('width'));
      $form_state->setValue(['attributes', 'height'], round(($original_height / $original_width) * $form_state->getValue('width')), 0, PHP_ROUND_HALF_UP);
    }
    else {
      $form_state->setValue(['attributes', 'width'], null);
      $form_state->setValue(['attributes', 'height'], null);
    }
